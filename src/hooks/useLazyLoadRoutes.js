...
const routes = {
  ...
  CasePlanTracker: lazy(() => import("@/pages/CasePlanTracker")),
  ...
  CrisisIntake: lazy(() => import("@/pages/CrisisIntake")),
  MyTeam: lazy(() => import("@/pages/MyTeam")),
  FamilyDashboard: lazy(() => import("@/pages/FamilyDashboard")),
  FamilyBackground: lazy(() => import("@/pages/FamilyBackground")),
  ...
  CommunicationJournal: lazy(() => import("@/pages/CommunicationJournal")),
  FamilyStabilityAnalytics: lazy(() => import("@/pages/FamilyStabilityAnalytics")),
  CourtReadyDocumentGenerator: lazy(() => import("@/pages/CourtReadyDocumentGenerator")),
  ...
  CaseInsightDashboard: lazy(() => import("@/pages/CaseInsightDashboard")),
  ...
  CertifiedLegalExport: lazy(() => import("@/pages/CertifiedLegalExport")),
