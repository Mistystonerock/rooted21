...
export const GUIDED_SECTIONS = [
  ...
  { key: "safe_locations", title: "Safe places", type: "list", fields: ["name", "address", "notes"] },
  { key: "code_words", title: "Emergency code words", type: "list", fields: ["word", "meaning", "who_knows"] },
  { key: "school_safety_plan", title: "School safety planning", type: "text", prompt: "List trusted school staff, pickup rules, who should not pick up the child, safe office steps, and what the school should do if there is a concern." },
  { key: "emotional_regulation_tools", title: "Emotional regulation tools", type: "checklist", defaults: ["Feelings chart", "Comfort object", "Quiet corner", "Weighted blanket or pressure pillow", "Drawing supplies", "Music or headphones", "Movement break", "Sensory kit"] },
  { key: "child_calming_exercises", title: "Calming exercises for children", type: "checklist", defaults: ["Balloon breathing", "5-4-3-2-1 grounding", "Butterfly hug", "Name five safe things", "Stretch like a cat", "Wall push-ups", "Slow counting", "Safe-place visualization"] },
  { key: "violence_exposure_coping_strategies", title: "Coping strategies after violence exposure", type: "text", prompt: "Write what helps the child after scary events: reassurance words, safe routines, who they can talk to, grounding steps, bedtime support, and when to contact a therapist or crisis support." },
