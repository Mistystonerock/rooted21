  ...
  return (
    <div className="min-h-screen" style={{ background: C.offWhite }}>
      <div className="px-5 py-4 flex items-center gap-3 sticky top-0 z-10" style={{ background: C.darkGreen }}>
        ...
        <div>
          <p className="font-serif font-bold" style={{ color: C.cream }}>21 Lessons</p>
          <p className="text-[10px]" style={{ color: C.lightGreen }}>{completedCount} of 21 complete</p>
        </div>
      ...
      <div className="max-w-[520px] mx-auto px-4 py-4 space-y-2">
        {LESSONS.map((lesson) => {
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm font-bold truncate" style={{ color: C.darkGreen }}>
                  {lesson.title}
                </p>
              </div>
        ...
        {completedCount === 21 && (
          <div className="rounded-2xl p-5 text-center mt-3" style={{ background: C.darkGreen }}>
            ...
            <p className="font-serif font-bold text-base" style={{ color: C.cream }}>You completed all 21 lessons!</p>
            <p className="text-xs mt-1" style={{ color: C.lightGreen }}>You are Rooted.</p>
          </div>
        )}
      </div>
    </div>
