    ...
    <div className="min-h-screen" style={{ background: C.offWhite }}>
      ...
      <main className="mx-auto max-w-[760px] space-y-4 px-4 py-5">
        <section className="rounded-2xl p-5" style={{ background: C.darkGreen }}>
          <p className="font-serif text-xl font-bold" style={{ color: C.cream }}>Roles are permission-based systems, not profile labels.</p>
          <p className="mt-2 text-sm leading-7" style={{ color: C.lightGreen }}>
            Each role defines what a person can access, what they can edit, what Moxie may do, which data segments are visible, and when documents can be shared. Rooted 21 keeps family-owned records centered on the family while professionals view relevant progress only through approved access.
          </p>
        </section>
        <section className="grid gap-3 md:grid-cols-3">
          {["Permission-based roles", "Family-owned records", "Consent-first sharing"].map(item => (
