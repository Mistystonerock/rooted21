...
const NATIONAL_DIRECTORIES = [
  ...
  {
    category: "🌱 Trauma-Informed Practitioners",
    color: C.midGreen,
    links: [
      {
        name: "Trust-Based Relational Intervention – Practitioner Directory",
        desc: "Official directory of trust-based, trauma-informed practitioners in all 50 states and 69 countries.",
        url: "https://child.tcu.edu/find-a-practitioner/",
      },
      {
        name: "Trauma-Informed Practitioner Directory",
        desc: "Searchable online directory of certified trauma-informed practitioners.",
...
const SEED_PROS = [
  {
    ...
    specialty: "therapist",
    bio: "Specializing in trauma-informed care for foster and adoptive families. 15+ years supporting children from hard places.",
    email: "maria.santos@example.com",
    location: "Austin, TX",
    tags: ["Trauma-Informed", "Foster Care", "Adoptive Families"],
