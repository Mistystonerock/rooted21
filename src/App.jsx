...
function App() {
  ...
  const professionalHomeRoles = ["professional", "licensed_mental_health_professional", "mental_health_professional", "case_manager", "behavioral_health_worker", "behavioral_health_provider", "treatment_team_member", "community_behavioral_health_worker", "tbs_provider", "cpst_provider", "peer_support_specialist", "risk_management_specialist", "recovery_coach", "ohiorise_care_coordinator", "treatment_court_mentor", "substance_use_counselor", "behavioral_health_supervisor", "therapist", "counselor", "caseworker"];
  ...
  const legalSupportHomeRoles = ["casa_gal", "casa", "gal", "attorney", "public_defender", "prosecutor", "court_staff", "magistrate", "judge_staff", "legal_support_viewer"];
  const loggedInHomePath = isFounder ? "/founder-dashboard" : user?.role === "admin" ? "/resource-management" : agencyHomeRoles.includes(user?.role) ? "/agency-admin" : resourcePartnerHomeRoles.includes(user?.role) ? "/resource-partner" : volunteerMentorHomeRoles.includes(user?.role) ? "/volunteer-mentor" : legalSupportHomeRoles.includes(user?.role) ? "/court-dashboard" : professionalHomeRoles.includes(user?.role) ? "/professional" : "/dashboard";
        ...
        <Router>
          ...
          <AnimatePresence mode="wait">
            ...
            <Routes>
              ...
              <Route path="/automated-briefing" element={<Suspense fallback={<LoadingFallback />}><FeatureLockGate user={user}><routes.AutomatedBriefing /></FeatureLockGate></Suspense>} />
              ...
              <Route path="/case-insights" element={<Suspense fallback={<LoadingFallback />}><FeatureLockGate user={user}><routes.CaseInsightDashboard /></FeatureLockGate></Suspense>} />
              ...
              <Route path="/consent-dashboard" element={<Suspense fallback={<LoadingFallback />}><FeatureLockGate user={user}><routes.ConsentDashboard /></FeatureLockGate></Suspense>} />
              ...
              <Route path="/resource-partner" element={<Suspense fallback={<LoadingFallback />}><FeatureLockGate user={user}><routes.CommunityResourcePartnerDashboard /></FeatureLockGate></Suspense>} />
              <Route path="/volunteer-mentor" element={<Suspense fallback={<LoadingFallback />}><FeatureLockGate user={user}><routes.VolunteerMentorDashboard /></FeatureLockGate></Suspense>} />
              ...
              <Route path="/role-governance" element={<Suspense fallback={<LoadingFallback />}><routes.RoleGovernance /></Suspense>} />
