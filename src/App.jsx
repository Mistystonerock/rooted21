...
function App() {
  ...
  const loggedInHomePath = user?.role === "founder" || user?.email === "misty.stonerock88@gmail.com" ? "/founder-dashboard" : user?.role === "admin" ? "/resource-management" : agencyHomeRoles.includes(user?.role) ? "/agency-admin" : resourcePartnerHomeRoles.includes(user?.role) ? "/resource-partner" : professionalHomeRoles.includes(user?.role) ? "/professional" : "/dashboard";
